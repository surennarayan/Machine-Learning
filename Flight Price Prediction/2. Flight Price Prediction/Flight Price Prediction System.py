...
predictor = pickle.load(open('D:\\Projects\\Completed\\2. Flight Price Prediction\\predictor_model.sav', 'rb'))
...
def main():
    ...
    df = pd.read_csv("D:\\Projects\\Completed\\2. Flight Price Prediction\\Clean_Dataset.csv")
    ...
    arrival_time_text = st.selectbox("Arrival Tine", list(arrival_time_options.keys()))
